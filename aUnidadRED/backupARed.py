...
# ===== VERIFICAR .env (AÑADIR AQUÍ) =====
print("\n" + "="*50)
print("📄 CONTENIDO DEL .env CARGADO:")
print("="*50)
for key, value in os.environ.items():
    if key in ['LOG_FILE', 'GMAIL_USER', 'SCRIPT_LOG', 'BACKUP_SOURCE','INTERVAL_HOURS', 'MAX_EXECUTIONS', 'START_TIME', 'EMAIL_TO']:
